...
class Core_Model_Content extends Core_Model_Abstract_ModelBase{
    ...
    public  function getTableName(){
        return Core::getTableName('content');
    }
    ...
    public function Save(){
        $content = new Core_Model_Content([0=>$this->Key]);
