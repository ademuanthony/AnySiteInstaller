...
class TwoCashout extends Core_Abstract_Module_Controller {
    public function Pay(){
        Core::redirectToAction('index', 'TwoCashout', 'payment');
    }
    ...
    public function Ping()
    {
        ...
        if ($_POST['credit_card_processed'] == "Y") {
            $transaction->Status = Core::OPEN_TRANSACTION_STATUS_COMPLETED;
            $transaction->Commit();
