...
class Voguepay extends Core_Abstract_Module_Controller {
    public function Pay(){
        Core::redirectToAction('index', 'Voguepay', 'payment');
    }
    ...
    public function Ping()
    {
        ...
        $merchant_id = Core::getField('Payment_Voguepay_MerchantId')->value;
        if(isset($_POST['transaction_id'])){
