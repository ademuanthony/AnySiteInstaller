...
class Service extends Core_Abstract_Module_Controller{
    public function Index($_page = 0){
        $this->data['user'] = $this->checkLogin(Core::OPEN_ROLE_ADMIN);
        $this->data['pageTitle'] = 'Manage Services | '.Core::getSystemSetting(Core::SITE_NAME);
    ...
    public function Process($id){
        ...
        if($success) {
            ...
            $this->data['request']->Status = Core::SERVICE_REQUEST_WAITING_FOR_BANK;
