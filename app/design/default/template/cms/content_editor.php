...
<div id="raw_content_editor" class="modal fade">
    <div class="modal-dialog">
        <form role="form" action="<?php echo Core::getActionUrl('save', '*', 'cms')?>" method="post">
            <input type="hidden" id="raw_editor_id" name="id">
            <input type="hidden" id="raw_editor_key" name="key">
            <input type="hidden" value="<?php echo Core::getCurrentUrl(); ?>?action=cms" name="returnUrl">
...
<div class="cms-submitter" style="display: none;">
    <form role="form" action="<?php echo Core::getActionUrl('save', '*', 'cms')?>?action=cms" method="post">
        ...
        <input type="hidden" value="<?php echo Core::getCurrentUrl(); ?>" name="returnUrl">
