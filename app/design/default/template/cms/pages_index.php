                    ...
                    <table class="table">
                        ...
                        <?php foreach($this->data['pages'] as $u){ ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo Core::getActionUrl('manage', 'pages', 'cms', [0 => $u->Permalink])?>" class="btn btn-info">Manage</a> |
                                    <a href="<?php echo Core::getActionUrl('delete', 'pages', 'cms', [0 => $u->Permalink])?>" class="btn btn-warning">Delete</a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
