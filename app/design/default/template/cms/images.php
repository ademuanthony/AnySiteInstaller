    ...
    <div class="row">
                    ...
                    <table class="table">
                        ...
                        <?php foreach($this->data['images'] as $key=>$link){ ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo Core::getActionUrl('deleteImage', 'cms', 'cms', [0 => $key])?>"
        ...
        <div class="col-md-5">
            ...
            <div class="box box-info">
                ...
                <form role="form" action="<?php echo Core::getActionUrl('addImage')?>" method="post" enctype="multipart/form-data">
                    <div class="box-body">
