...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="<?php echo Core::getBaseUrl()?>app/design/default/assets/frontend/css/bootstrap.css" rel="stylesheet">
    <link href="<?php echo Core::getBaseUrl()?>app/design/default/assets/frontend/css/font-awesome.min.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="<?php echo Core::getBaseUrl()?>app/design/default/assets/frontend/css/main.css" rel="stylesheet">
...
<div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="loginModalLabel" aria-hidden="true">
    ...
    <form role="form" action="<?php echo Core::getActionUrl('login' , 'account', 'account')?>" method="post">
        <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<div class="modal fade" id="registerModal" tabindex="-1" role="dialog" aria-labelledby="registerModal" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <form role="form" action="<?php echo Core::getActionUrl('register' , 'account', 'account')?>" method="post">
            <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<script src="<?php echo Core::getBaseUrl()?>app/design/default/assets/frontend/js/bootstrap.min.js"></script>
<?php $this->renderSpecialView(Core::VIEW_POSITION_FOOTER);?>
</body>
</html>
