...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo Core::getActionUrl('Index')?>"><i class="fa fa-group"></i> Group</a></li>
...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-danger">
                ...
                <form action="<?php echo Core::getActionUrl('update', '*', 'group', ['parameter1' => $this->data['group']->Id])?>" method="post">
    ...
    <div class="row">
                        ...
                        <tbody>
                            <?php foreach($this->data['contacts'] as $contact){?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo Core::getActionUrl('DeleteContact', '*', 'group',
        ...
        <div class="col-md-4">
            ...
            <div class="box box-primary">
                <form action="<?php echo Core::getActionUrl('addContact', '*', 'group', ['parameter1' => $this->data['group']->Id])?>" method="post">
