    ...
    <div class="row">
                        ...
                        <?php foreach ($this->data['groups'] as $group) {?>
                            <li class="item">
                                ...
                                <div class="product-info">
                                    <a href="<?php echo Core::getActionUrl('detail', '*', 'group', ['parameter1'=>$group->Id])?>" class="product-title"><?php echo $group->Name?></a>
                                    <a href="<?php echo Core::getActionUrl('delete', '*', 'group', ['parameter1'=>$group->Id])?>" class="btn btn-danger btn-xs pull-right"><i class="fa fa-times"></i></a>
        ...
        <div class="col-md-4">
            ...
            <div class="box box-info">
                <form action="<?php echo Core::getActionUrl('Add', '*')?>" method="post">
