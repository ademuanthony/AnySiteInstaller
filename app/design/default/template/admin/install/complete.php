...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="<?php echo Core::getActionUrl('index', 'dashboard')?>"><i class="fa fa-dashboard"></i> Admin</a></li>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="username" required="required"
                                   name="username" value="<?php echo $this->getFormData('username', Core::FORM_POST_METHOD)?>"
