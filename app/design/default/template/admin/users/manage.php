...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo Core::getActionUrl('Index')?>"><i class="fa fa-group"></i> User</a></li>
...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-danger">
                ...
                <form method="post"
                      action="<?php echo Core::getActionUrl('update', 'users', 'admin', [0 => $this->data['curUser']->LoginId])?>">
    ...
    <div class="row">
                        ...
                        <table class="table">
                            ...
                            <?php foreach($this->data['transactions'] as $tran){?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo Core::getActionUrl('Delete', 'Transactions', 'Admin',
                                            ['parameter1' => $tran->Id], ['returnUrl' =>
                                                urlencode(Core::getActionUrl('Manage', 'Users', 'Admin', [0=>$this->data['curUser']->LoginId]))])?>"
        ...
        <div class="col-md-4">
            ...
            <div class="box box-primary">
                <form action="<?php echo Core::getActionUrl('add', 'transactions')?>" method="post">
                    <div class="box-header">
                    ...
                    <div class="box-body">
                        <input type="hidden" name="returnUrl"
                               value="<?php echo Core::getActionUrl('Manage', 'Users', 'Admin', [0 => $this->data['curUser']->LoginId])?>">
                        ...
                        <div class="form-group">
                            ...
                            <?php Core_Helper_Html::SelectFor('PaymentMethod',
