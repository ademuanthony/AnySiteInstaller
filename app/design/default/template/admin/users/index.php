    ...
    <div class="row">
                        ...
                        <tbody>
                            <?php foreach($this->data['users'] as $u){ ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo Core::getActionUrl('manage', 'users', 'admin', [0 => $u->LoginId])?>" class="btn btn-info">Manage</a> |
                                        <a href="<?php echo Core::getActionUrl('delete', 'users', 'admin', [0 => $u->LoginId])?>" class="btn btn-warning">Delete</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
        ...
        <div class="col-md-5">
            ...
            <div class="box box-info">
                ...
                <form role="form" action="<?php echo Core::getActionUrl('add')?>" method="post">
                    <div class="box-body">
