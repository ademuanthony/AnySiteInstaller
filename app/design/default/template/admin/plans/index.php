...
<section class="content-header">
    <h1>
        Manage Plans <small><a href="<?php echo Core::getActionUrl('Add')?>">Create Plan</a></small>
    </h1>
    <ol class="breadcrumb">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <table class="table">
                        ...
                        <tbody>
                            <?php foreach($this->data['plans'] as $u){ ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo Core::getActionUrl('manage', 'plans', 'admin', [0 => $u->Id])?>"
