    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    <a class="btn btn-primary" href="<?php echo Core::getActionUrl('Detail', 'Themes', 'Admin', [0 => $this->data['theme']->key])?>">Manage Theme</a>
                </div>
            </div><!-- /.box -->
        </div>
        ...
        <div class="col-md-8">
            <img style="margin-bottom: 10px;" alt="No Screen shot"
                ...
                Core::getBaseUrl().Core::NO_IMAGE ?>" class="image img-responsive"/>
        </div>
    </div>
    ...
    <div class="row">
                    ...
                    <table class="table">
                        ...
                        foreach($this->data['themes'] as $theme){ ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo Core::getActionUrl('detail', 'themes', 'admin', [0 => strtolower($theme->key)])?>"
        ...
        <div class="col-md-5">
            ...
            <div class="box box-info">
                ...
                <form enctype="multipart/form-data" role="form" action="<?php echo Core::getActionUrl('add')?>" method="post">
                    <div class="box-body">
