...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo Core::getActionUrl('Index', 'Modules', 'Admin')?>">Modules</a></li>
...
<section class="content">
    ...
    <form method="post"action="<?php echo Core::getActionUrl('Update'); ?>">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input type="submit" class="btn btn-primary btn-lg"
                                       value="<?php echo Core::OPEN_OPTION_YES == $this->data['module']->enabled ? 'Disable': 'Enable' ?>" name="Disable"/>
                            </div>
                            <div class="col-md-6">
                        ...
                        <table class="table">
                            ...
                            <?php $sn = 0; foreach($this->data['module']->payments as $p){ ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php Core_Helper_Html::SelectFor($p->key.'[order_status]',
                                            [Core::OPEN_TRANSACTION_STATUS_PENDING,
                                                Core::OPEN_TRANSACTION_STATUS_AWAITING_PAYMENT,
                                                Core::OPEN_TRANSACTION_STATUS_PROCESSING,
                                                Core::OPEN_TRANSACTION_STATUS_COMPLETED],
                                            $p->order_status, null, null, ['class'=>'form-control']); ?>
                                    </td>
                                    <td><?php Core_Helper_Html::TextEditorFor($p->key.'[sort_order]', $p->sort_order, ['class'=>'form-control']) ?></td>
                                    <td><?php Core_Helper_Html::SelectFor($p->key.'[enabled]',
                                            [Core::OPEN_OPTION_YES, Core::OPEN_OPTION_NO],
                        ...
                        <table class="table">
                            ...
                            <?php $sn = 0; foreach($this->data['module']->fields as $p){ ?>
                                <tr>
                                    ...
                                    <td><?php Core_Helper_Html::TextEditorFor($p->key.'[sort_order]', $p->sort_order, ['class'=>'form-control']) ?></td>
                                    <td><?php Core_Helper_Html::TextEditorFor($p->key.'[value]', $p->value, ['class'=>'form-control']) ?></td>
                                </tr>
