...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            <form action="<?php echo Core::getActionUrl('update', 'transactions')?>" method="post">
                ...
                <div class="box-body">
                    <input type="hidden" name="returnUrl"
                           value="<?php echo Core::getActionUrl('Manage', 'Transactions', 'Admin',
                    ...
                    <div class="form-group">
                        ...
                        <?php Core_Helper_Html::SelectFor('Status',
                            Core::getTransactionStatusArray(), $this->data['transaction']->Status, null, null,
                            ['class'=>'form-control']); ?>
