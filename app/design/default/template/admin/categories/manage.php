...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo Core::getActionUrl('Index')?>"><i class="fa fa-group"></i> Categories</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-danger">
                ...
                <form method="post"
                      action="<?php echo Core::getActionUrl($this->data['formAction'], 'plans', 'admin', [0 => $this->data['category']->Id])?>">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo !empty($this->data['plan']->SortOrder)?$this->data['plan']->SortOrder:''; ?>"
                                           type="text" class="form-control" id="name" name="sortOrder" placeholder="Sort Order">
                                </div>
                            </div>
