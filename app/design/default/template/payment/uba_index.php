        ...
        <div class="col-md-7">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <strong><?php echo Core::getField('Payment_UBA_Notification_Number')->value?></strong>
                    <table class="table">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><?php echo Core::getField('Payment_UBA_Account_Name')->value?></td>
                        </tr>
                        <tr>
                            <td><strong>Account Number</strong></td>
                            <td><?php echo Core::getField('Payment_UBA_Account_Number')->value?></td>
                        </tr>
                    </table>
