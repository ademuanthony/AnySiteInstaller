...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo Core::getActionUrl('Index', 'Transaction', 'Account')?>"><i class="fa fa-dashboard"></i> Transaction</a></li>
        ...
        <div class="col-md-7">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Load Voucher</h3>
                    <div class="box-tools pull-right">
                        <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body">
                    Please enter the PIN and serial number of your voucher below and click submit
                    <form method="post" action="<?php echo Core::getActionUrl('Index'); ?>">
                        <div class="form-group">
                            <label for="no">Serial Number</label>
                            <input type="text" class="form-control" id="no" required name="serialNumber">
                        </div>
                        <div class="form-group">
                            <label for="unit">PIN</label>
                            <input type="text" class="form-control" required id="pin" name="pin">
                        </div>

                        <div class="form-group">
                            <input type="submit" value="Load Voucher" class="btn btn-primary" />
                        </div>
                    </form>
